...
# Load movie dataset
movies = pd.read_csv("C:/minor_project/movies_expanded.csv")
...
popular_df = pd.read_pickle('C:/minor_project/popular.pkl')
pt = pd.read_pickle('C:/minor_project/pt.pkl')
books = pd.read_pickle('C:/minor_project/books.pkl')
books = pd.read_pickle('C:/minor_project/books_with_genre.pkl')
...
similarity_scores = pickle.load(open('C:/minor_project/similarity_scores.pkl','rb'))
...
@app.route('/genre')
def genre():
    genres = books['Genre'].uniqueprint("print("")")()
